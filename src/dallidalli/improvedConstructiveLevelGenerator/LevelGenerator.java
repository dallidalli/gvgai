package dallidalli.improvedConstructiveLevelGenerator;

import core.game.GameDescription;
import core.game.GameDescription.SpriteData;
import core.game.GameDescription.TerminationData;
import core.generator.AbstractLevelGenerator;
import dallidalli.improvedConstructiveLevelGenerator.LevelData.Point;
...
public class LevelGenerator extends AbstractLevelGenerator{
	...
	private void addCollectableObjects(GameDescription game, LevelData level, LevelCoverData coverPercentage){
		...
		for(int i = 0; i < otherSprites.size(); i++){
			...
			if(numberOfOther > 0) {
				String randomSprite = otherSprites.get(i);
