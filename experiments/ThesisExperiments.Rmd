...
wilcox.test(maxValues$maxMCTS, maxValues$maxNMCS)
wilcox.test(maxValues$maxMCTS, maxValues$maxNRPA, alternative = "two.sided")
wilcox.test(maxValues$maxNMCS, maxValues$maxNRPA)

t.test(maxValues$maxMCTS, maxValues$maxNMCS)
t.test(maxValues$maxMCTS, maxValues$maxNRPA, alternative = "two.sided")
t.test(maxValues$maxNMCS, maxValues$maxNRPA)
```
